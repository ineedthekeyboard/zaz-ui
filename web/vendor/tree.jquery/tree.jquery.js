...
(function e(t, n, r) {
	...
	1: [function (require, module, exports) {
		...
		HitAreasGenerator = (function (superClass) {
			...
			HitAreasGenerator.prototype.generateHitAreasForGroup = function (hit_areas, positions_in_group, top,
				bottom) {
		...
		KeyHandler = (function () {
			...
			KeyHandler.prototype.selectNode = function (node) {
				if (!node) {
					...
					if (this.tree_widget.scroll_handler && (!this.tree_widget.scroll_handler.isScrolledIntoView($(node.element)
							.find('.jqtree-element')))) {
